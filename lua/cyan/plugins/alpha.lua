return {
  ...
  opts = function()
    ...
    dashboard.section.header.val = {
      ...
      {
        type = 'text',
        val = '⊹ ' .. os.date '  %d %B ' .. ' • ' .. '  v' .. version.major .. '.' .. version.minor .. '.' .. version.patch .. ' ⊹',
    ...
    dashboard.section.buttons.val = {
      ...
      dashboard.button('s', '󱊒  > Search Session ', '<cmd>SessionSearch<cr>'),
      dashboard.button('r', '󰚰  > Restore Session', '<cmd>SessionRestore<cr>'),
